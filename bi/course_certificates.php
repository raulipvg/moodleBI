        	...
        	<table class="table">
				<thead>
			    	<tr>
					    ...
					    <th scope="col">Numero usuarios</th>
			    	</tr>
			  	</thead>
			  	<tbody>
			  		<?php foreach ($report->get_certificate_per_course() as $key => $course): ?>
			  			<tr>
				      		<th scope="row"><?php echo $key; ?></th>
					      	<td><?php echo $course->fullname; ?></td>
					      	<td><?php echo $course->to_char; ?></td>
					      	<td><?php echo $course->numbercertificates; ?></td>
				    	</tr>	
			  		<?php endforeach ?>	
				</tbody>
			</table>
